...
description: React 和 Next.js 性能优化模式，改编自 Vercel Engineering 的 React Best Practices。按 8 个优先级类别组织 70+ 条规则 —— 瀑布流、包大小、服务端、客户端获取、重渲染、渲染、JS 微性能、高级。编写、审查或重构 React/Next.js 代码以优化性能时使用。
origin: ECC
---
