---
name: react-patterns
description: React 18/19 模式，包括 hooks 纪律、服务端/客户端组件边界、Suspense + 错误边界、表单 actions、数据获取、状态管理决策树和可访问性优先组合。编写或审查 React 组件时使用。
origin: ECC
---
...
### 使用 React 19 `useOptimistic` 的乐观 UI
