**语言：** English | [Português (Brasil)](docs/pt-BR/README.md) | [简体中文](README.zh-CN.md) | [繁體中文](docs/zh-TW/README.md) | [日本語](docs/ja-JP/README.md) | [한국어](docs/ko-KR/README.md) | [Türkçe](docs/tr/README.md) | [Русский](docs/ru/README.md) | [Tiếng Việt](docs/vi-VN/README.md) | [ไทย](docs/th/README.md) | [Deutsch](docs/de-DE/README.md)
...
<sub>**开源保持免费。** 本仓库永远采用 MIT 许可。ECC Pro 是用于私有仓库的托管 GitHub 应用。<a href="https://github.com/sponsors/affaan-m">赞助者</a>和<a href="https://ecc.tools/pricing">Pro 订阅者</a>资助这项工作 — 这就是为什么单个维护者能够跨 7 个 harness 每周发布更新。</sub>
...
此项目是免费和开源的。赞助商帮助保持其维护和增长。

[**成为赞助商**](https://github.com/sponsors/affaan-m) | [赞助商级别](SPONSORS.md) | [赞助计划](SPONSORING.md)
