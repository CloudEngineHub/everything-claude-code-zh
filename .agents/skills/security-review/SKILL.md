...
description: 在添加身份验证、处理用户输入、使用机密、创建 API 端点或实现支付/敏感功能时使用此技能。提供全面的安全检查清单和模式。
---
...
**记住**：安全不是可选的。一个漏洞可能会损害整个平台。如有疑问，请谨慎行事。
